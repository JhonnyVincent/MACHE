    ...
    <main className="min-h-screen bg-[#f3f4f8]">
      <div className="grid min-h-screen lg:grid-cols-[260px_1fr]">
        ...
        <aside className="hidden bg-[#070707] text-white lg:block">
          ...
          <nav className="space-y-2 p-4 text-sm font-bold">
            ...
            {[
              ...
              [
                "Ajouter produit",
                `/dashboard/seller/stores/${store.id}/products/new`,
                "➕",
              ],

              [
                "Commandes",
                `/dashboard/seller/stores/${store.id}/orders`,
                "🛒",
              ],

              [
                "Stock",
                `/dashboard/seller/stores/${store.id}/stock`,
                "📊",
              ],

              [
                "Documents",
                `/dashboard/seller/stores/${store.id}/documents`,
                "📄",
              ],

              [
                "Paramètres",
                `/dashboard/seller/stores/${store.id}/settings`,
                "⚙️",
              ],
            ].map(([label, href, icon]) => (
              <Link
        ...
        <section className="overflow-y-auto">
          ...
          <div
            className="relative h-64 bg-gradient-to-r from-[#070707] via-[#111827] to-[#d2162c]"
          >
          ...
          <div className="space-y-7 p-8">
            ...
            <div className="rounded-3xl border bg-white p-6 shadow-sm">
              ...
              <div className="flex h-72 items-end gap-3 rounded-2xl bg-[#f7f8fb] p-5">
                ...
                {[35, 55, 45, 70, 60, 90, 75, 120, 95, 140, 110, 160].map(
                  (height, index) => (
